...
// }
 ...
 //    	// p3: ''                                 // Image 3 converted to > Data URL with Base64-encoded string (optional)
    ...
    // 						console.log('Second Notification sent');
				...
				// Get last song
				// Check if the last song already exist on the array
				// If no
					// add it
					// Check if the previous song already exist on the array
				// If yes
					// stop
...
function init_twilio(){
	let text = 'Hello World',
		client_number = '+33669999682';

	send_twilio_sms( text, client_number )
		.then( is_sms_sent => {
